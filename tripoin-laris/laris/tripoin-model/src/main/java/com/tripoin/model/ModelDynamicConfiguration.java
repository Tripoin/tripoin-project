...
import com.tripoin.common.constant.ApplicationConstant.Database.TableTestConfiguration;
...
public class ModelDynamicConfiguration {
    ...
    @DatabaseField(generatedId = true, canBeNull = false, columnName = Database.ID)
    private int id;
